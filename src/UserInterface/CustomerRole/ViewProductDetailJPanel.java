...
public class ViewProductDetailJPanel extends javax.swing.JPanel {
    ...
    public ViewProductDetailJPanel(JPanel upc, Product product) {
        ...
        txtPrice.setText(Integer.toString(product.getTargetPrice()));
    ...
    private void initComponents() {
        ...
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 90, -1, 30));
        ...
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 170, -1, 30));

        txtPrice.setEditable(false);
        txtPrice.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        add(txtPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 170, 159, -1));
        ...
        add(backButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 300, -1, -1));

        idField.setEditable(false);
        idField.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        add(idField, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 130, 159, -1));

        jLabel5.setFont(new java.awt.Font("Calibri", 3, 17)); // NOI18N
        jLabel5.setText("Product ID:");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 130, -1, 30));
        ...
        add(txtAvail, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 220, 160, -1));
